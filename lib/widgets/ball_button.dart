...
class BallPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final shadowPath = Path()
      ..addOval(Rect.fromCircle(
          center: center.translate(0, radius * 0.05), radius: radius));
    canvas.drawShadow(
        shadowPath, Colors.black.withValues(alpha: 0.4), 2.0, true);
  ...
  void _drawStripedBall(
      Canvas canvas, Offset center, double radius, int number) {
    // 1. White base
  ...
  void _drawNumberCircle(Canvas canvas, Offset center, double radius) {
    ...
    canvas.drawCircle(center.translate(1, 1), circleRadius,
  ...
  Color _getBallColor(int number) {
    switch (number) {
      ...
      case 2:
      case 10:
        return const Color(0xFF003399); // Deep Blue
      case 3:
      case 11:
        return const Color(0xFFCC0000); // Red
      case 4:
      case 12:
        return const Color(0xFF4B0082); // Purple
      case 5:
      case 13:
