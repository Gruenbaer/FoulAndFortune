...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get gameRulesContent =>
      'Foul & Fortune: Straight Pool\nRegeln folgen dem Standard-14.1 Straight Pool (Drei-Foul-Regel, Neuaufbau); die App nutzt eine Eingabe der verbleibenden Objektkugeln für schnelleres Zählen.\n\n1. Spielziel\nDas Ziel ist es, die festgelegte Punktzahl zu erreichen (Rennen bis X).\n\n2. Punktevergabe\nDu trägst ein, wie viele Objektkugeln nach deinem Stoß verbleiben.\nDie Punkte für den Stoß ergeben sich aus der Abnahme der verbleibenden Kugeln.\nWenn 1 Kugel verbleibt, wird auf 15 neu aufgebaut und deine Aufnahme läuft weiter.\nWenn du den Tisch komplett abräumst, wird es als Double Sack (15) erfasst.\n\n3. Spezielle Kugeln\n- Kugel 1: Bringt 14 Punkte und führt zu einem Neuaufbau. Spieler macht weiter.\n- Doppel-Sack (Spielball): Bringt 15 Punkte und führt zu einem Neuaufbau. Spieler macht weiter.\n\n4. Fouls\n- Normales Foul: -1 Punkt.\n- Schweres Foul: -2 Punkte.\n- Drei-Foul (TF): Drei aufeinanderfolgende Fouls mit 0 Punkten in jeder Aufnahme lösen TF aus. TF beendet die Aufnahme und zählt -16 für diese Aufnahme (-1 Foul plus zusätzliche -15). Über drei Fouls beträgt die Summe -18. Notation ist TF (kein separates F).';
